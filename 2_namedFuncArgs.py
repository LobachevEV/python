def printUserData(first_name, last_name, birth_year, birth_city, residence_city, email, phone):
    print(f'{first_name} {last_name} {birth_year} {birth_city} {residence_city} {email} {phone}')


if __name__ == '__main__':
    printUserData(first_name=input('Enter a user first name: '), last_name=input('Enter a user last name: '),
